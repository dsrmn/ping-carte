...
def check_card(client, card_name, blueprint_entries, criteria, min_listings, sent_alerts, allowed_seller_countries, foil_only_from_year):
    ...
    for entry in blueprint_entries:
        ...
        # Espansioni dall'anno soglia in poi: solo foil. Prima di quell'anno
        # (o se l'anno non è noto): sia foil che non foil, nessun filtro.
...
def main():
    ...
    for card_name, blueprint_entries in cards_index.items():
        if not blueprint_entries:
            continue
        deals = check_card(client, card_name, blueprint_entries, criteria, min_listings, sent_alerts, allowed_seller_countries, foil_only_from_year)
