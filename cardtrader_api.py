...
class CardTraderClient:
    ...
    def get_marketplace_products(self, blueprint_id: int, language: str | None = "en", foil: bool | None = None):
        """Ritorna le inserzioni attive in vendita per una blueprint_id.
        Filtra per lingua lato API (default: inglese) quando 'language' è impostato.
        Filtra per foil lato API quando 'foil' è True o False (None = non filtra)."""
